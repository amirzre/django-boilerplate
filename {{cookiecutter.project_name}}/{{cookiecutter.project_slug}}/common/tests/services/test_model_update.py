...
from {{cookiecutter.project_slug}}.blog_examples.models import TimestampsOpinionated
from {{cookiecutter.project_slug}}.common.factories import RandomModelFactory, SimpleModelFactory
